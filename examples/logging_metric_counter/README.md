...
Configuration in this directory creates a simple logs-based counter metric.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_logging_metric_counter_labeled"></a> [logging\_metric\_counter\_labeled](#module\_logging\_metric\_counter\_labeled) | smartscaling/logging-metric/google |  |
